...
class ClassClock extends Component {
    ...
    componentWillMount() {
        // mounting to to screen
        console.warn("componentWillMount sets the time as :" + this.state.date);
    }

    componentDidMount() {
        //did it mount to the screen
        console.error("componentDidMount sets the time as :" + this.state.date);
        this.timerID = setInterval(() => this.tick(), 1000);
    }
    componentWillUpdate() {
        // will i update as the time changes it does
    ...
    shouldComponentUpdate() {
        // check if it should update or not 
